    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            ...
            <div class="widget-head am-cf">
                <div class="widget-title  am-cf">专著管理</div>
            </div>
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <c:if test="${monographsEntity.status== 0}">
                                                <a href="javascript:void(0);" onclick="Edit('${monographsEntity.id}','${monographsEntity.status}')" data-am-modal="{target: '#edit', closeViaDimmer: 0, width: 600, height: 300}">
...
<script type="text/javascript">
    ...
    function GetManager(pagesize, nowpage) {
        location.href = "../index/monographsList.action?pageSize=" + pagesize + "&pageNum=" + nowpage;
    }
    ...
    function addwhere()
    {
        ...
        location.href = "../index/monographsList.action?pageSize=" + pagesize + "&pageNum=" + nowpage  + "&monographsname=" + encodeURI(encodeURI(monographsname)) ;
    }
        ...
        $.ajax({
            ...
            success: function (data)
            {
                if(data.jsonResult.state){
                    location.href = "../index/monographsList.action";
                }
                else {
