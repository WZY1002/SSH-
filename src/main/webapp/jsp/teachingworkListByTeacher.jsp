...
<script type="text/javascript">
    ...
    function GetManager(pagesize, nowpage) {
        location.href = "../teacherIndex/teachingworkEntityList.action?pageSize=" + pagesize + "&pageNum=" + nowpage;
    }
    ...
    function addwhere()
    {
        ...
        location.href = "../teacherIndex/teachingworkEntityList.action?pageSize=" + pagesize + "&pageNum=" + nowpage  + "&coursename=" +  encodeURI(encodeURI(coursename))   + "&starttime=" +  encodeURI(encodeURI(starttime))  + "&endtime=" +  encodeURI(encodeURI(endtime));
    }
