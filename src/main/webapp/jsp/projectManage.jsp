            ...
            <div class="widget-body  am-fr">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                        <input id="seltitle" type="text" class="am-form-field " placeholder="项目名称">
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <c:if test="${projectEntity.status== 0}">
                                                <a href="javascript:void(0);" onclick="Edit('${projectEntity.id}','${projectEntity.status}')" data-am-modal="{target: '#edit', closeViaDimmer: 0, width: 600, height: 300}">
...
<script type="text/javascript">
    ...
    function GetManager(pagesize, nowpage) {
        location.href = "../index/projectList.action?pageSize=" + pagesize + "&pageNum=" + nowpage;
    }
    ...
    function addwhere()
    {
        ...
        location.href = "../index/projectList.action?pageSize=" + pagesize + "&pageNum=" + nowpage  + "&name=" + encodeURI(encodeURI(name)) ;
    }
        ...
        $.ajax({
            ...
            success: function (data)
            {
                if(data.jsonResult.state){
                    location.href = "../index/projectList.action";
                }
                else {
