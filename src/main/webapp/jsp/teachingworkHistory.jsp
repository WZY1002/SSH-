    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            ...
            <div class="widget-head am-cf">
                <div class="widget-title  am-cf">教学计划查看</div>
            </div>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <a href="javascript:void(0);" onclick="Edit('${teachingworkEntity.id}','${teachingworkEntity.classhour}','${teachingworkEntity.classnumber}','${teachingworkEntity.starttime}','${teachingworkEntity.endtime}','${teachingworkEntity.coursename}','${teachingworkEntity.classname}')" data-am-modal="{target: '#edit', closeViaDimmer: 0, width: 600, height: 600}">
                    ...
                    <div class="am-modal am-modal-no-btn" tabindex="-1" id="edit">
                        <div class="am-modal-dialog">
                            <div class="am-modal-hd">
                                <p style="color:black;">修改教学计划信息</p>
                                <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
                            </div>
                            <div class="am-modal-bd" style="color:black;">
                                <form class="am-form" id="editform" enctype="multipart/form-data">
                                    <div class="am-form-group">
                                        <input type="text" id="edclasshour" name="classhour" placeholder="课时" required>
                                        <input type="text" id="id" name="id" style="display: none">
                                    </div>
                                    <div class="am-form-group">
                                        <input type="text" id="edclassnumber" name="classnumber" placeholder="课数" required>
                                    </div>
                                    <div class="am-form-group">
                                        <input type="text" id="edstarttime" name="starttime" placeholder="开始时间" required>
                                    </div>
                                    <div class="am-form-group">
                                        <input type="text" id="edendtime" name="endtime" placeholder="结束时间" required>
                                    </div>
                                    <div class="am-form-group">
                                        <input type="text" id="edcoursename" name="coursename" placeholder="课程名" required>
                                    </div>
                                    <div class="am-form-group">
                                        <input type="text" id="edclassname" name="classname" placeholder="班级名" required>
                                    </div>
                                    <%--<div class="am-form-group">--%>
...
<script type="text/javascript">
    ...
    //获取编辑信息
    function Edit(id,classhour,classnumber,starttime,endtime,coursename,classname)
    {
        $("#id").val(id);
        $("#edclasshour").val(classhour);
        $("#edclassnumber").val(classnumber);
        $("#edstarttime").val(starttime);
        $("#edendtime").val(endtime);
        $("#edcoursename").val(coursename);
        $("#edclassname").val(classname);
    }
