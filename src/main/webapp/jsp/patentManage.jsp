    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            ...
            <div class="widget-head am-cf">
                <div class="widget-title  am-cf">专利管理</div>
            </div>
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <c:if test="${patentEntity.status== 0}">
                                                <a href="javascript:void(0);" onclick="Edit('${patentEntity.id}','${patentEntity.status}')" data-am-modal="{target: '#edit', closeViaDimmer: 0, width: 600, height: 300}">
...
<script type="text/javascript">
    ...
    function GetManager(pagesize, nowpage) {
        location.href = "../index/patentList.action?pageSize=" + pagesize + "&pageNum=" + nowpage;
    }
    ...
    function addwhere()
    {
        ...
        location.href = "../index/patentList.action?pageSize=" + pagesize + "&pageNum=" + nowpage  + "&name=" + encodeURI(encodeURI(name)) ;
    }
        ...
        $.ajax({
            ...
            success: function (data)
            {
                if(data.jsonResult.state){
                    location.href = "../index/patentList.action";
                }
                else {
